...
exports.config = {
    ...
    seleniumAddress: 'http://10.117.162.227:4444/wd/hub',//http://10.117.163.33:4444/wd/hub',
    framework: 'jasmine2',
    ...
    baseUrl: 'https://10.160.205.134/ui',
    ...
    onPrepare: function () {
        ...
        racetrack.testSetBegin('12346', 'Test', 'None', 'test description', '', '', '', 'Release', 'Regression', 'Japanese').then(function() {
            racetrack.testSetData('BU', 'CPBU');
        }).then(function(){
            racetrack.testSetData('Product', 'ESXUI');
        }).then(function(){
            racetrack.testSetData('ReleaseNumber', '2016');
        }).then(function(){
            racetrack.testSetData('Locale', 'zh_CN');
        }).then(function(){
    ...
    params: {
        ...
        //storageMsg: require('./i18n/msg/en-us/rstorage.json'),
        //missingMsg: require('./i18n/msg/en-us/missingstrings.json')
        ...
        // storageMsg: require('./i18n/msg/zh-cn/rstorage.json'),
        // taskMsg: require('./i18n/msg/zh-cn/task.json'),
        // missingMsg: require('./i18n/msg/zh-cn/missingstrings.json'),
        ...
        // storageMsg: require('./i18n/msg/fr-fr/storage.json'),
        // taskMsg: require('./i18n/msg/fr-fr/task.json'),
        // missingMsg: require('./i18n/msg/fr-fr/missingstrings.json'),

        // networkMsg: require('./i18n/msg/ja-jp/network.json'),
        // vmMsg: require('./i18n/msg/ja-jp/vm.json'),
        // hostMsg: require('./i18n/msg/ja-jp/host.json'),
        // storageMsg: require('./i18n/msg/ja-jp/storage.json'),
        // taskMsg: require('./i18n/msg/ja-jp/task.json'),
        // missingMsg: require('./i18n/msg/ja-jp/missingstrings.json'),

        networkMsg: require('./i18n/msg/de-de/network.json'),
        vmMsg: require('./i18n/msg/de-de/vm.json'),
        hostMsg: require('./i18n/msg/de-de/host.json'),
        storageMsg: require('./i18n/msg/de-de/storage.json'),
        taskMsg: require('./i18n/msg/de-de/task.json'),
        missingMsg: require('./i18n/msg/de-de/missingstrings.json')
        ...
        // storageMsg: require('./i18n/msg/es-es/storage.json'),
        // taskMsg: require('./i18n/msg/es-es/task.json'),
        // missingMsg: require('./i18n/msg/es-es/missingstrings.json')

        // networkMsg: require('./i18n/msg/zh-tw/network.json'),
        // vmMsg: require('./i18n/msg/zh-tw/vm.json'),
        // hostMsg: require('./i18n/msg/zh-tw/host.json'),
        // storageMsg: require('./i18n/msg/zh-tw/storage.json'),
        // taskMsg: require('./i18n/msg/zh-tw/task.json'),
        // missingMsg: require('./i18n/msg/zh-tw/missingstrings.json'),
