...
```
Error: boo!
    at explode (/path/to/globalUtil.js:3:11)
    at _fulfilled (/path/to/globalUtil.js:q:54)
...
Error: boo!
    at explode (/path/to/globalUtil.js:3:11)
From previous event:
    at theDepthsOfMyProgram (/path/to/globalUtil.js:2:16)
    at Object.<anonymous> (/path/to/globalUtil.js:7:1)
```
