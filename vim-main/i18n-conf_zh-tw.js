...
exports.config = {
    ...
    seleniumAddress: 'http://10.161.36.87:4444/wd/hub',
    framework: 'jasmine2',
    ...
    baseUrl: 'https://10.161.29.230/ui',
    ...
    onPrepare: function () {
        ...
        racetrack.testSetBegin(browser.params.build.number, 'yanyant', 'G11N_ESXUI', 'G11n Automation testing for Host Client.', '', '',
            browser.params.build.branch, browser.params.build.type, 'Regression', 'Chinese Traditional').then(function() {
            ...
            racetrack.testSetData('Locale', 'zh_TW');
        }).then(function(){
