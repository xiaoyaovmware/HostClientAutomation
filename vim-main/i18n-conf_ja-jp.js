...
exports.config = {
    ...
    seleniumAddress: 'http://10.162.45.91:4444/wd/hub',
    framework: 'jasmine2',
    ...
    baseUrl: 'https://10.161.171.139/ui',
    ...
    onPrepare: function () {
        ...
        racetrack.testSetBegin(browser.params.build.number, 'yanyant', 'G11N_ESXUI', 'G11n Automation testing for Host Client.', '', '',
            browser.params.build.branch, browser.params.build.type, 'Regression', 'Japanese').then(function() {
            ...
            racetrack.testSetData('Locale', 'ja_JP');
        }).then(function(){
    ...
    params: {
        ...
        roleName: {
            noCryptographyAdministrator: "非暗号化管理者",
            noAccess: "アクセスなし",
            readOnly: "読み取り専用",
        ...
        messagesMsg: require('./i18n/msg/ja-jp/messages.json'),
