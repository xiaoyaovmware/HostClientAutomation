...
exports.config = {
    ...
    seleniumAddress: 'http://10.192.182.10:4444/wd/hub',
    framework: 'jasmine2',
    ...
    baseUrl: 'https://10.192.55.236/ui',
    ...
    onPrepare: function () {
        ...
        racetrack.testSetBegin(browser.params.build.number, 'yanyant', 'G11N_ESXUI', 'G11n Automation testing for Host Client.', '', '',
            browser.params.build.branch, browser.params.build.type, 'Regression', 'French').then(function() {
            ...
            racetrack.testSetData('Locale', 'fr_FR');
        }).then(function(){
    ...
    params: {
        ...
        roleName: {
            noCryptographyAdministrator: "Aucun administrateur de chiffrement",
