...
describe('Edit Settings for Non-ASCII VM Delete Component', function () {
    ...
    beforeEach(function () {
        ...
        console.log("-----------------------------------------------------------------------------------------");
        console.log("                    Edit Settings for Non-ASCII VM Delete Component                      ");
        console.log("-----------------------------------------------------------------------------------------");

        browser.driver.manage().window().maximize();

        return racetrack.testCaseBegin('Edit Settings for Non-ASCII VM Delete Component', 'Edit VM', 'Edit Settings for Non-ASCII VM Delete Component', browser.params.i18n.lang, '', '', 'UI','P0','Automation').then(function(){
            return globalUtil.takeScreenshot(screenshotSavePath, 'Edit_Settings_for_Non-ASCII_VM_SATA_Delete_Component_Start');
        }).then(function() {
    ...
    afterEach(function (done) {
        return globalUtil.verifyResult('Edit_Settings_for_Non-ASCII_VM_Delete_Component_Stop',screenshotSavePath).then(function(){
            done();
        });
    });


    it('Edit Settings for Non-ASCII VM Delete Component and verify', function () {
        ...
        return racetrack.log('---------------------------------------Start Test Case--------------------------------------').then(function() {
            ...
            return racetrack.log("Delete component Network Adapter, CD/DVD Drive and Hard Disk");
        }).then(function () {
            ...
            return globalUtil.waitForVisibility(editSettingsDialog.networkAdapterSlideDown.removeButton(0,false));
        }).then(function () {
            return editSettingsDialog.networkAdapterSlideDown.removeButton(0,false).click();
        }).then(function () {
            return globalUtil.waitForVisibility(editSettingsDialog.cdromSlideDown.removeButton(0,false));
        }).then(function () {
            return editSettingsDialog.cdromSlideDown.removeButton(0,false).click();
        }).then(function () {
