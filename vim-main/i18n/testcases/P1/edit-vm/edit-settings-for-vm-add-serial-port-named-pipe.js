...
describe('Edit Settings for Non-ASCII VM Add Serial Port Named Pipe', function () {
    ...
    beforeEach(function () {
        ...
        console.log("-----------------------------------------------------------------------------------------");
        console.log("               Edit Settings for Non-ASCII VM Add Add Serial Port Named Pipe             ");
        console.log("-----------------------------------------------------------------------------------------");

        browser.driver.manage().window().maximize();

        return racetrack.testCaseBegin('Edit Settings for Non-ASCII VM Add Serial Port Named Pipe', 'Edit VM', 'Edit Settings for Non-ASCII VM Add Serial Port Named Pipe', browser.params.i18n.lang, '', '', 'UI','P1','Automation').then(function(){
            return globalUtil.takeScreenshot(screenshotSavePath, 'Edit_Settings_for_Non-ASCII_VM_Add_Serial_Port_Named_Pipe_Start');
        }).then(function() {
    ...
    afterEach(function (done) {
        return globalUtil.verifyResult('Edit_Settings_for_Non-ASCII_VM_Add_Serial_Port_Named_Pipe_Stop',screenshotSavePath).then(function(){
            done();
        });
    });


    it('Edit Settings for Non-ASCII VM Add Serial Port Named Pipe', function () {
        ...
        return racetrack.log('---------------------------------------Start Test Case--------------------------------------').then(function() {
            ...
            return racetrack.log("Add a new Serial Port - Use Named Pipe serial port.");
        }).then(function () {
            ...
            return racetrack.log("Select serial port type: " + 'Use Named Pipe serial port');
        }).then(function () {
            ...
            return globalUtil.waitForVisibility(editSettingsDialog.serialPortSlideDown.serialTypeDropDown.serialType(2));
        }).then(function () {
            return editSettingsDialog.serialPortSlideDown.serialTypeDropDown.serialType(2).click();
        }).then(function () {
            return globalUtil.waitForVisibility(editSettingsDialog.serialPortSlideDown.pipeNameTextbox());
        }).then(function () {
            return editSettingsDialog.serialPortSlideDown.pipeNameTextbox().sendKeys(browser.params.i18n.string);
        }).then(function () {
