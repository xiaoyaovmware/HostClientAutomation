...
describe('Edit Settings for Non-ASCII VM Add Serial Port Physical', function () {
    ...
    beforeEach(function () {
        ...
        console.log("-----------------------------------------------------------------------------------------");
        console.log("                Edit Settings for Non-ASCII VM Add Add Serial Port Physical              ");
        console.log("-----------------------------------------------------------------------------------------");

        browser.driver.manage().window().maximize();

        return racetrack.testCaseBegin('Edit Settings for Non-ASCII VM Add Serial Port Physical', 'Edit VM', 'Edit Settings for Non-ASCII VM Add Serial Port Physical', browser.params.i18n.lang, '', '', 'UI','P1','Automation').then(function(){
            return globalUtil.takeScreenshot(screenshotSavePath, 'Edit_Settings_for_Non-ASCII_VM_Add_Serial_Port_Physical_Start');
        }).then(function() {
    ...
    afterEach(function (done) {
        return globalUtil.verifyResult('Edit_Settings_for_Non-ASCII_VM_Add_Serial_Port_Physical_Stop',screenshotSavePath).then(function(){
            done();
        });
    });


    it('Edit Settings for Non-ASCII VM Add Serial Port Physical', function () {
        ...
        return racetrack.log('---------------------------------------Start Test Case--------------------------------------').then(function() {
            ...
            return racetrack.log("Add a new Serial Port - Use Physical serial port.");
        }).then(function () {
            ...
            return racetrack.log("Select serial port type: " + 'Use physical serial port');
        }).then(function () {
            ...
            return globalUtil.waitForVisibility(editSettingsDialog.serialPortSlideDown.serialTypeDropDown.serialType(1));
        }).then(function () {
            return editSettingsDialog.serialPortSlideDown.serialTypeDropDown.serialType(1).click();
        }).then(function () {
