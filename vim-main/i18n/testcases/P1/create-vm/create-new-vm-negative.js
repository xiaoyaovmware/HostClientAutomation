...
describe('Create New non-ASCII VM Negative', function () {
    ...
    beforeEach(function () {
        ...
        console.log("-----------------------------------------------------------------------------------------");
        console.log("                                  Create New VM Negative                                 ");
        console.log("-----------------------------------------------------------------------------------------");
        ...
        return racetrack.testCaseBegin('Create New non-ASCII VM Negative','Create VM','Create New non-ASCII VM Negative',browser.params.i18n.lang,'','','UI','P0','Automation').then(function() {
            return globalUtil.takeScreenshot(screenshotSavePath, 'Create_New_non-ASCII_VM_Negative_Start');
        }).then(function() {
    ...
    afterEach(function (done) {
        return globalUtil.verifyResult('Create_New_non-ASCII_VM_Negative_Stop', screenshotSavePath).then(function(){
            done();
        });
    });

    it('Create a non-ASCII VM Negative and verify', function () {
       ...
       return racetrack.log('---------------------------------------Start Test Case--------------------------------------').then(function(){
           ...
           return racetrack.log("Do not enter VM name and click Next button");
       }).then(function () {
           return globalUtil.waitForVisibility(newVMWizard.nextButton());
       }).then(function () {
           return newVMWizard.nextButton().click();
           ...
           return racetrack.log("Do not select Guest OS Family and click Next button");
       }).then(function () {
           return globalUtil.waitForVisibility(newVMWizard.nextButton());
       }).then(function () {
           return newVMWizard.nextButton().click();
           ...
           return racetrack.log("Do not select Guest OS and click Next button");
       }).then(function () {
           return globalUtil.waitForVisibility(newVMWizard.nextButton());
       }).then(function () {
           return newVMWizard.nextButton().click();
           ...
           return racetrack.log("- - Enter RAM size: 123" );
       }).then(function () {
           return newVMWizard.memoryTextbox(0).sendKeys(123);
       }).then(function () {
           return globalUtil.waitForVisibility(newVMWizard.nextButton());
       }).then(function () {
           return newVMWizard.nextButton().click();
           ...
           return newVMWizard.memoryTextbox(1).clear();
       }).then(function () {
           return racetrack.log("- - Enter correct RAM size: 124" );
       }).then(function () {
           return newVMWizard.memoryTextbox(1).sendKeys(124);
       }).then(function () {
           ...
           return newVMWizard.hardDiskSlideDown.hardDiskSizeTextbox(0,false).clear();
       }).then(function () {
           return globalUtil.waitForVisibility(newVMWizard.nextButton());
       }).then(function () {
           return newVMWizard.nextButton().click();
