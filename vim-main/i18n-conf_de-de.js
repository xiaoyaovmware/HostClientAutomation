...
exports.config = {
    ...
    onPrepare: function () {
        ...
        racetrack.testSetBegin(browser.params.build.number, 'yanyant', 'G11N_ESXUI', 'G11n Automation testing for Host Client.', '', '',
            browser.params.build.branch, browser.params.build.type, 'Regression', 'German').then(function() {
            ...
            racetrack.testSetData('Locale', 'de_DE');
        }).then(function(){
    ...
    params: {
        ...
        roleName: {
            noCryptographyAdministrator: "Kein Kryptografie-Administrator",
        ...
        messagesMsg: require('./i18n/msg/de-de/messages.json'),
