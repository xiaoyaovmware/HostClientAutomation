...
exports.config = {
    ...
    seleniumAddress: 'http://10.117.163.30:4444/wd/hub',
    framework: 'jasmine2',
    ...
    baseUrl: 'https://10.161.231.14/ui',
    ...
    onPrepare: function () {
        ...
        racetrack.testSetBegin(browser.params.build.number, 'tomluo', 'G11N_ESXUI', 'G11n Automation testing for Host Client.', '', '',
            browser.params.build.branch, browser.params.build.type, 'Regression', 'English').then(function() {
            ...
            racetrack.testSetData('Locale', 'en_US');
        }).then(function(){
    ...
    params: {
        ...
        storageMsg: require('./i18n/msg/en-us/storage.json'),
        taskMsg: require('./i18n/msg/en-us/task.json'),
