...
exports.config = {
    ...
    seleniumAddress: 'http://10.192.109.92:4444/wd/hub',
    framework: 'jasmine2',
    ...
    baseUrl: 'https://10.160.182.37/ui',
    ...
    onPrepare: function () {
        ...
        racetrack.testSetBegin(browser.params.build.number, 'yanyant', 'G11N_ESXUI', 'G11n Automation testing for Host Client.', '', '',
            browser.params.build.branch, browser.params.build.type, 'Regression', 'Spanish').then(function() {
            ...
            racetrack.testSetData('Locale', 'es_ES');
        }).then(function(){
