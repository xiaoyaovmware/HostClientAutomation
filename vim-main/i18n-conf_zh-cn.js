...
exports.config = {
    ...
    specs: [
        ...
        // 'i18n/testcases/P1/services/enter-exit-maintenance-mode-power-on-vm-exist.js',   //add
    ...
    onPrepare: function () {
        ...
        racetrack.testSetBegin(browser.params.build.number, 'yanyant', 'G11N_ESXUI', 'G11n Automation testing for Host Client.', '', '',
            browser.params.build.branch, browser.params.build.type, 'Regression', 'Chinese Simplify').then(function() {
